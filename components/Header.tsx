                ...
                <div className="px-4 py-3 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-gray-700 truncate">{currentUser.email}</div>
                    </div>
                  </div>
                  {currentUser.is_admin && (
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div
                ...
                className="hidden absolute top-14 right-4 w-64 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50"
                onClick={(e) => e.stopPropagation()}
              >
                <div className="px-4 py-3 border-b border-gray-100">
                  <div className="flex items-center gap-3">
            ...
            <div className="mt-4 pb-2 space-y-4">
              ...
              <div className="flex flex-col gap-2">
                <button
                  ...
                  } px-4 py-3 rounded-lg font-medium text-sm transition-colors text-left`}
                >
                  Expenses
                </button>
                <button
              ...
              {currentUser.is_admin && allUsers.length > 0 && (
                <div className="space-y-2">
                  <label className="text-sm font-medium text-gray-700 block">View As:</label>
                  <select
                    value={masqueradingAsUser?.id || ''}
                    onChange={(e) => {
                      const userId = e.target.value;
              ...
              {masqueradingAsUser && (
                <div className="flex items-center gap-2 px-3 py-2 bg-orange-100 border border-orange-300 rounded-lg">
                  ...
                  <span className="text-xs font-medium text-orange-800 flex-1">
                    Viewing as: {masqueradingAsUser.full_name}
                  </span>
                  <button
                    onClick={() => onMasqueradeChange(null)}
